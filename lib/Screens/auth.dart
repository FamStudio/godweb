  ...
  Widget build(BuildContext context) {
    ...
    Widget _logo(){
      return Padding(
        ...
        child: Container(
          child: Align(
            child: Text('Your Practice', style: TextStyle(fontSize: 45, fontWeight: FontWeight.bold, color: Colors.white),),
          ),
        ),
      );
    }
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: _input(Icon(Icons.email_outlined), "EMAIL", _emailController, false),
            ),
            Padding(
              padding: EdgeInsets.only(bottom: 20, top: 10),
          ...
          Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.all(10),
                child: GestureDetector(
                  child: Text('Already registered yet? Login!', style: TextStyle(fontSize: 20, color: Colors.white,)),
                  onTap: (){
                    setState(() {
                      showLogin = true;
                    });
